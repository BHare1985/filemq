...
if [ ! -f $PWD/raspbian_filemq.img ]; then

# Allocate disk space for extended image
truncate -s 1536M raspbian_filemq.img

# Begin partitioning disk image.
# Creating two partitions:
# BOOT = 100 MB
# ROOT = 1536 MB
fdisk raspbian_filemq.img <<EOF
o
n
p
1
...
export LOOPDEV_EX="$(losetup --show --find raspbian_filemq.img)"
